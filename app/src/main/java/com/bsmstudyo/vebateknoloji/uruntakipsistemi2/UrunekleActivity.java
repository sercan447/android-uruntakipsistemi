...
public class UrunekleActivity extends Activity implements View.OnClickListener,RadioGroup.OnCheckedChangeListener{
    ...
    private final String INSERT_URL = "http://www.alfatoptancilik.com/android_webservisleri/insert_products.php";
    private final String DINAMIK_KATEGORI = "http://alfatoptancilik.com/android_webservisleri/show_category.php";
    private final String KOD_YARAT_LINKI = "http://alfatoptancilik.com/android_webservisleri/product_create_code.php";
